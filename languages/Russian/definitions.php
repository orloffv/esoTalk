...
$definitions["Don't have an account? <a href='%s' class='link-join'>Sign up!</a>"] = "Нет аккаунта? <a href='%s' class='link-join'>Зарегестрироваться!</a>";
...
$definitions["Sign Up"] = "Зарегестрироваться";
