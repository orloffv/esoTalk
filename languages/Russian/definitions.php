...
ET::$languageInfo["Russian"] = array(
	"locale" => "ru-RU",
	"name" => "Русский",
	"description" => "Бета версия русского языка",
	"version" => ESOTALK_VERSION,
	"author" => "Orloffv",
	"authorEmail" => "mail@orloffv.ru",
	"authorURL" => "http://orloffv.ru",
	"license" => "GPLv2"
);
...
$definitions["date.full"] = "j M Y, G:i \G\M\TO"; // see http://au.php.net/manual/en/function.date.php for details
...
$definitions["%s conversation"] = "%s тема";
$definitions["%s conversations"] = "%s темы";
$definitions["%s invited you to %s."] = "%s invited you to %s.";
$definitions["%s joined the forum."] = "%s зашел на форум.";
$definitions["%s post"] = "%s post";
$definitions["%s posted %s"] = "%s отправил %s";
$definitions["%s posted in %s."] = "%s написал в %s.";
$definitions["%s posts"] = "%s тем";
$definitions["%s reply"] = "%s ответ";
$definitions["%s replies"] = "%s ответов";
$definitions["%s Settings"] = "%s Settings";
$definitions["%s started the conversation %s."] = "%s создал новую тему %s.";
$definitions["%s tagged you in a post."] = "%s mentioned you in a post.";
$definitions["%s will be able to view this conversation."] = "%s могут видеть эту тему.";
...
$definitions["Back to conversation"] = "Вернуться в тему";
...
$definitions["Change Channel"] = "Изменение канала";
...
$definitions["Click on a member's name to remove them."] = "Кликните на имя пользователя, чтобы удалить его.";
...
$definitions["Conversations started"] = "Созданных тем";
...
$definitions["Delete conversation"] = "Удалить тему";
...
$definitions["Deleted %s by %s"] = "Удалено %s %s";
$definitions["Disable"] = "Disable";
$definitions["Discard Draft"] = "Удалить черновик";
$definitions["Don't have an account? <a href='%s' class='link-join'>Sign up!</a>"] = "Нет аккаунта? <a href='%s' class='link-join'>Зарегистрироваться!</a>";

$definitions["Edit Channel"] = "Edit Channel";
$definitions["Edit Group"] = "Edit Group";
$definitions["Edit member groups"] = "Edit member groups";
$definitions["Edit your profile"] = "Изменить мой профиль";
$definitions["Edit"] = "Редактировать";
$definitions["Edited %s by %s"] = "Изменено %s %s";
...
$definitions["Enter a conversation title"] = "Введите название темы";
...
$definitions["Filter conversations..."] = "Фильтр тем...";
...
$definitions["Forum language"] = "Язык";
...
$definitions["group.member"] = "Пользователь";
...
$definitions["Jump to last"] = "К последнему сообщению";
$definitions["Jump to unread"] = "К последнему непрочитанному сообщению";
...
$definitions["Keep me logged in"] = "Запомнить";
...
$definitions["Mark all as read"] = "Отметить весь форум прочитанным";
...
$definitions["Members Allowed to View this Conversation"] = "Пользователи, которые могут видеть эту тему";
$definitions["Members Online"] = "Пользователей на сайте";
...
$definitions["New Conversation"] = "Новая тема";
...
$definitions["Post a Reply"] = "Публикация ответа";
$definitions["Post count"] = "Post count";
$definitions["Posts"] = "Сообщений";
...
$definitions["Start a conversation"] = "Создать тему";
$definitions["Start a private conversation with %s"] = "Start a private conversation with %s";
$definitions["Start Conversation"] = "Создать тему";
$definitions["Starting a conversation"] = "Создает новую тему";
$definitions["Statistics"] = "Статистика";
$definitions["statistic.conversation.plural"] = "%s тем";
$definitions["statistic.conversation"] = "%s conversation";
$definitions["statistic.member.plural"] = "%s пользователи";
$definitions["statistic.member"] = "%s пользователь";
...
$definitions["View %s's profile"] = "Посмотреть профиль %s";
...
$definitions["message.emptyTitle"] = "Название вашей темы не может быть пустым. Я имею в виду, как можно нажать на пустое название? Подумайте об этом.";
...
$definitions["message.incorrectLogin"] = "Введенные данные не верны.";
...
$definitions["message.logInToReply"] = "<a href='%1\$s' class='link-login'>Войти</a> или <a href='%2\$s' class='link-join'>зарегестрироваться</a> что бы написать!";
...
$definitions["message.noMembersOnline"] = "Никого нет онлайн.";
...
$definitions["message.waitToReply"] = "Вы должны подождать по крайней мере %s секунд между началом и ответом на тему. Сделайте глубокий вдох и повторите попытку.";
